...
public class RegisterUserDetailService implements UserDetailsService {
 ...
 public UserDetails loadUserByUsername(String username)
  ...
  try {
   ...
   // DbUser is our custom domain user. This is not the same as Spring's User
	  UserAccount dbUser = commonDao.searchUserDatabase(username);
	  System.out.println(dbUser+"Db?User===========================>>>>>>>>>>>");
