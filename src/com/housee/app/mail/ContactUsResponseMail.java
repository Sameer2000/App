...
public class ContactUsResponseMail extends SendMailAPI{
	     ...
	     */
	    public void email(String emailId, String userFullName, String phone, String message, String reply) {
	        String recipient = emailId; //replace this with a valid recipient email address
	        String content = MailFormatData.getContactUsResponseMailData(emailId, phone, message,reply);
